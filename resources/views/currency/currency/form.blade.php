...
<div class="form-group {{ $errors->has('sale_rate') ? 'has-error' : ''}}">
 ...
 {!! Form::number('sale_rate', null, ['step' => 0.01, 'min' => 0.00, 'class' => 'form-control', 'required' => 'required']) !!}
...
<div class="form-group {{ $errors->has('purchase_rate') ? 'has-error' : ''}}">
 ...
 {!! Form::number('purchase_rate', null,  ['step' => 0.01, 'min' => 0.00, 'class' => 'form-control', 'required' => 'required']) !!}
 {!! $errors->first('purchase_rate', '<p class="help-block">:message</p>') !!}
</div>


<div class="form-group">
 <a href="{{ url('/currency') }}" class="btn btn-danger btn-sm mr-5" title="Back"><i class="fa fa-arrow-left" aria-hidden="true"></i> Retour</a>
